...
const BlogEliminasiTB = () => {
  ...
  useEffect(() => {
    ...
    const unsubscribe = onSnapshot(q, (querySnapshot) => {
      ...
      const filteredByCategory = sortedBlogs.filter(berita => berita.categories === 'Eliminasi TB');
  ...
  return (
    <>
      <Breadcrumb
        pageName="Berita Eliminasi TB"
        description="Berita Eliminasi TB Lembaga Inisiatif Lampung Sehat"
      />
...
export default BlogEliminasiTB;
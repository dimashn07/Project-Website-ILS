...
const BlogLayananKesehatanPublik = () => {
  ...
  useEffect(() => {
    ...
    const unsubscribe = onSnapshot(q, (querySnapshot) => {
      ...
      const filteredByCategory = sortedBlogs.filter(berita => berita.categories === 'Layanan Kesehatan Publik');
  ...
  return (
    <>
      <Breadcrumb
        pageName="Berita Layanan Kesehatan Publik"
        description="Berita Layanan Kesehatan Publik Lembaga Inisiatif Lampung Sehat"
      />
...
export default BlogLayananKesehatanPublik;
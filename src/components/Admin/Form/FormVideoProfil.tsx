...
export function FormVideoProfil({ handleSimpanClick, mode, deskripsi, setDeskripsi, videoURL, setVideoURL, setGambar }) {
        ...
        <form className="flex max-w-7xl flex-col" onSubmit={handleSimpanClick}>
            <div className="relative z-0 w-full mb-5 group">
                ...
                <textarea 
                    ...
                    required className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" >
                </textarea>
            </div> 
            <div className="relative z-0 w-full mb-5 group">
                <label htmlFor="base-input" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                ...
                <input
                    type="text" id="link" name="link" value={videoURL} onChange={(e) => setVideoURL(e.target.value)} placeholder="Masukkan link video"

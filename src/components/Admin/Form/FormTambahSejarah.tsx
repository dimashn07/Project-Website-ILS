...
export function FormTambahSejarah() {
    ...
    return (
        <form className="flex max-w-7xl flex-col">
            <div className="relative z-0 w-full mb-5 group">
                <textarea 
                    id="deskripsi" name="deskripsi" value={deskripsi} onChange={handleChange} placeholder="Masukkan paragraf"

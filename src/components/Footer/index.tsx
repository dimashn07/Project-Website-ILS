        ...
        <div className="container">
            ...
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                <Link href="/" className="mb-8 inline-block">
                  <Image
                    src="/images/logo/logo-ils-footer.svg"
                    alt="logo"
                ...
                <p className="mb-9 text-base leading-relaxed text-body-color dark:text-body-color-dark">
                  Bergerak Bersama Inisiatif Lampung Sehat dalam penanggulangan Penyakit menular khususnya tuberkulosis (TB).
                </p>
          ...
          <div className="py-8">
            <p className="text-center text-base text-body-color dark:text-white">
              © Copyright <strong>Inisiatif Lampung Sehat</strong> 2024.
            </p>
          </div>
        </div>

        <div className="absolute right-0 top-0 z-50 w-1/2" style={{ marginTop: '64px', marginRight: '120px', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.5)', borderRadius: '8px' }}>
